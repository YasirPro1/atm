...
if (pinAns.pin === myPin) {
    ...
    if (actionAns.action === "Fast Cash") {
        ...
        if (fixAmountAns.fixAmount === "1000") {
            console.log(`$1000 Withdraw successfully, Your remaining balance is: $${(myBalance -=
                fixAmountAns.fixAmount)}`);
        }
        else if (fixAmountAns.fixAmount === "2000") {
            console.log(`$2000 Withdraw successfully, Your remaining balance is: $${(myBalance -=
                fixAmountAns.fixAmount)}`);
        }
        else if (fixAmountAns.fixAmount === "5000") {
            console.log(`$5000 Withdraw successfully, Your remaining balance is: $${(myBalance -=
                fixAmountAns.fixAmount)}`);
        }
        else if (fixAmountAns.fixAmount === "10000") {
            console.log(`$10000 Withdraw successfully, Your remaining balance is: $${(myBalance -=
                fixAmountAns.fixAmount)}`);
        }
    }
        ...
        if (amountAns.amount > myBalance) {
            ...
            console.log(`Withdraw successfuly, Your remaining balance is: $${myBalance}`);
        }
    }
